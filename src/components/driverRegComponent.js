...
export default class DiverReg extends React.Component {
    ...
    onPressRegister(){
       ...
       if ( fnameValid && lnameValid && mobileValid && emailValid && passwordValid && cnfPwdValid && vehicleNumValid && vehicleNameValid  ) {
            //register function of smart component
            onPressRegister( this.state.fname, this.state.lname, this.state.mobile, this.state.email, this.state.password, this.state.vehicleNum, this.state.vehicleName);
